...
export class GithubActionsRole extends Construct {
  ...
  constructor(scope: Construct, id: string, props: GithubActionsRoleProps) {
    ...
    // NOTE: If the provider already exists, you'll need to manually delete the stack and recreate it
    // or import the existing provider using CfnOIDCProvider and importOpenIdConnectProvider
    ...
    new cdk.CfnOutput(this, 'RoleArn', {
      ...
      description: 'The ARN of the IAM role for GitHub Actions (us-east-2)',
    });
